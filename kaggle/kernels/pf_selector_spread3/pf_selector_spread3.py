"""
ROGII Wellbore Geology Prediction - PF selector spread3 candidate.

Adapted from the public Kaggle notebook:
needless090/lb8-781-rogii-sel15-spread3

Strategy:
  - Visible training wells: physical contact model
  - Hidden test wells: PF ensemble with likelihood weighting plus beam/hold selector
    init_spread=2.0 ft (wider initial particle spread)
    GR interpolated before PF so NaN gaps still contribute a continuous path
"""
