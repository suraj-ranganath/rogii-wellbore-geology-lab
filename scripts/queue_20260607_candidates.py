...
STATE_PATH = Path("outputs/queue_20260607_state.json")
...
CANDIDATES = [
    Candidate(
        ...
        version=1,
        message="ridge w040 pf40 robust seed average",
        kernel_dir=Path("kaggle/kernels/ridge_w040_pf40"),
        output_dir=Path("outputs/queue_20260607/ridge_w040_pf40"),
    ),
    Candidate(
        name="ridge_w040_selector070",
        kernel="surajranganath17/rogii-ridge-w040-selector070",
        version=1,
        message="ridge w040 selector070 calibrated blend",
        kernel_dir=Path("kaggle/kernels/ridge_w040_selector070"),
        output_dir=Path("outputs/queue_20260607/ridge_w040_selector070"),
    ),
    Candidate(
        name="ridge_w040_selector080",
        kernel="surajranganath17/rogii-ridge-w040-selector080",
        version=1,
        message="ridge w040 selector080 aggressive selector",
        kernel_dir=Path("kaggle/kernels/ridge_w040_selector080"),
        output_dir=Path("outputs/queue_20260607/ridge_w040_selector080"),
    ),
    Candidate(
        name="ridge_w040_prefix_gate",
        kernel="surajranganath17/rogii-ridge-w040-prefix-gate",
        version=1,
        message="ridge w040 prefix ncc gated anchor",
        kernel_dir=Path("kaggle/kernels/ridge_w040_prefix_gate"),
        output_dir=Path("outputs/queue_20260607/ridge_w040_prefix_gate"),
    ),
    Candidate(
        name="ridge_w040_formprefix_gate",
        kernel="surajranganath17/rogii-ridge-w040-formprefix-gate",
        version=1,
        message="ridge w040 formation prefix gated",
        kernel_dir=Path("kaggle/kernels/ridge_w040_formprefix_gate"),
        output_dir=Path("outputs/queue_20260607/ridge_w040_formprefix_gate"),
    ),
]
