...
STATE_PATH = Path("outputs/queue_20260606_hidden_safe_state.json")
...
CANDIDATES = [
    Candidate(
        ...
        kernel="surajranganath17/rogii-ridgecpu-w020-0605",
        version=3,
        message="ravaghi ridge hidden-safe v3 w020",
        kernel_dir=Path("kaggle/kernels/ravaghi_ridge_w020"),
        output_dir=Path("outputs/queue_20260606_hidden_safe/ravaghi_ridge_w020"),
    ),
    Candidate(
        name="ravaghi_ridge_w025",
        kernel="surajranganath17/rogii-ridgecpu-w025-0605",
        version=3,
        message="ravaghi ridge hidden-safe v3 w025",
        kernel_dir=Path("kaggle/kernels/ravaghi_ridge_w025"),
        output_dir=Path("outputs/queue_20260606_hidden_safe/ravaghi_ridge_w025"),
    ),
    Candidate(
        name="ravaghi_ridge_w030",
        kernel="surajranganath17/rogii-ridgecpu-w030-0605",
        version=3,
        message="ravaghi ridge hidden-safe v3 w030",
        kernel_dir=Path("kaggle/kernels/ravaghi_ridge_w030"),
        output_dir=Path("outputs/queue_20260606_hidden_safe/ravaghi_ridge_w030"),
    ),
    Candidate(
        name="ravaghi_ridge_w035",
        kernel="surajranganath17/rogii-ridgecpu-w035-0605",
        version=3,
        message="ravaghi ridge hidden-safe v3 w035",
        kernel_dir=Path("kaggle/kernels/ravaghi_ridge_w035"),
        output_dir=Path("outputs/queue_20260606_hidden_safe/ravaghi_ridge_w035"),
    ),
    Candidate(
        name="ravaghi_ridge_w040",
        kernel="surajranganath17/rogii-ridgecpu-w040-0605",
        version=3,
        message="ravaghi ridge hidden-safe v3 w040",
        kernel_dir=Path("kaggle/kernels/ravaghi_ridge_w040"),
        output_dir=Path("outputs/queue_20260606_hidden_safe/ravaghi_ridge_w040"),
    ),
]
